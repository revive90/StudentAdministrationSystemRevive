namespace StudentAdministrationSystemRevive.Views.Accounts
{
    partial class frmCreateAccount
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3 = new Label();
            txtCA_ConfirmEmail = new TextBox();
            label8 = new Label();
            txtCAFirstname = new TextBox();
            label9 = new Label();
            btnCreateStudentAccount = new Button();
            ...
            // 
            // btnCreateStudentAccount
            // 
            btnCreateStudentAccount.BackColor = Color.RoyalBlue;
            btnCreateStudentAccount.Cursor = Cursors.Hand;
            btnCreateStudentAccount.FlatAppearance.BorderSize = 0;
            ...
            btnCreateStudentAccount.Click += btnCreateStudentAccount_Click;
            // 
            // lblForgotPassword
            // 
            ...
            // cmbStartYear
            // 
            cmbStartYear.DropDownStyle = ComboBoxStyle.DropDownList;
            ...
            // cmbProgrammes
            // 
            cmbProgrammes.DropDownStyle = ComboBoxStyle.DropDownList;
            ...
            Controls.Add(btnCreateStudentAccount);
            Controls.Add(txtCALastName);
            Controls.Add(label3);
            Controls.Add(txtCA_ConfirmEmail);
            Controls.Add(label8);
            Controls.Add(txtCAFirstname);
            Controls.Add(label9);
            Controls.Add(txtConfirmPassword);
            Controls.Add(label6);
            Controls.Add(txtSetPassword);
            Controls.Add(label7);
        ...
        private TextBox txtCA_ConfirmEmail;
        private Label label8;
        private TextBox txtCAFirstname;
        private Label label9;
        private Button btnCreateStudentAccount;
